...
public class Main extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        animator.setResolution(0);//không giới hạn resolution → tức là để nó tick càng nhanh càng tốt, phụ thuộc vào khả năng CPU + hệ thống.
        regist.setLayout(layout);
        regist.add(cover, "width " + coverSize + "%, pos 0al 0 n 100%");
        regist.add(loginAndRegister, "width " + loginSize + "%, pos " + (isLogin ? "0al" : "1al") + " 0 n 100%"); //  1al as 100%
    ...
    private void initComponents() {
        ...
        regist = new javax.swing.JLayeredPane();
    ...
    private javax.swing.JLayeredPane regist;
